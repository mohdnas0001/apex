      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="flex flex-col items-center md:mt-16 lg:mt-12 lg:gap-4">
          <div className="mb-4 flex flex-row items-center justify-between gap-2 rounded-full border border-gray-200 bg-white px-4 py-1">
            ...
            <p className="font-sans font-normal leading-6 text-gray-900 md:text-sm lg:text-base">
              APEX Technology
            </p>
          </div>
          ...
          <div className="relative flex w-full items-center justify-center overflow-hidden rounded-lg md:h-28 lg:h-44">
            ...
            />
            <button className="relative z-10 transform rounded-lg bg-black font-bold text-white shadow-lg transition duration-300 ease-in-out hover:scale-105 md:px-8 md:py-1 md:text-sm lg:px-14 lg:py-2 lg:text-base">
              Get Started
            </button>
          </div>
        </div>
